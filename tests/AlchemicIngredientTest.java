...
public class AlchemicIngredientTest {
    ...
    public void testSetName() {
        assertThrows(IngredientName.IllegalNameException.class, () -> ingredient = new AlchemicIngredient("Invalid Name1",temp,state,10));
        assertThrows(IngredientName.IllegalNameException.class, () -> ingredient = new AlchemicIngredient("",temp,state,10));
        assertThrows(IngredientName.IllegalNameException.class, () -> ingredient = new AlchemicIngredient("Ba",temp,state,10));
        assertThrows(IngredientName.IllegalNameException.class, () -> ingredient = new AlchemicIngredient("abC",temp,state,10));
        assertThrows(IngredientName.IllegalNameException.class, () -> ingredient = new AlchemicIngredient("ABc mixed with abC",temp,state,10));
        assertThrows(IngredientName.IllegalNameException.class, () -> ingredient = new AlchemicIngredient("FULL CAPS",temp,state,10));
        assertThrows(IngredientName.IllegalNameException.class, () -> ingredient = new AlchemicIngredient("Not \"Valid\" Name",temp,state,10));
        try{
            ingredient = new AlchemicIngredient("Valid \'name",temp,state,10);
        } catch (IngredientName.IllegalNameException e) {
            fail("Valid name should not throw an exception: " + e.getMessage());
        }
        try{
        ...
        try {
            ingredient = new AlchemicIngredient("Valid Name mixed with Another Valid Name",temp,state,10);
        } catch (IngredientName.IllegalNameException e) {
            fail("Valid name should not throw an exception: " + e.getMessage());
        }
        try {
            ingredient = new AlchemicIngredient("Ab Cd mixed with Ef",temp,state,10);
        } catch (IngredientName.IllegalNameException e) {
            fail("Valid name should not throw an exception: " + e.getMessage());
        }
        try {
            ingredient = new AlchemicIngredient("Abc",temp,state,10);
        } catch (IngredientName.IllegalNameException e) {
            fail("Valid name should not throw an exception: " + e.getMessage());
        }
    }
